...
#LastEditTime : 2020-06-01 15:51:39
...
if __name__ == "__main__":
    ...
    urls = ['https://www.biqukan.com/38_38836/', 'https://www.biqukan.com/65_65593/']
    main(urls[0])

    # #[笔趣阁-Vthread＆沧元图main.txt]保存完成	size: 3,478.69 KB	time:15:42:43.628108。
