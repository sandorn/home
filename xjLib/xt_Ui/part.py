...
Date         : 2024-06-17 14:04:39
LastEditTime : 2024-06-17 14:04:41
FilePath     : /CODE/xjLib/xt_Ui/part.py
...
class xt_QTableView(QTableView):
    ...
    def 单行选择(self):
        self.setSelectionBehavior(QAbstractItemView.SelectionMode.SingleSelection)
