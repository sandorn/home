...
from xjLib.mystr import Ex_Re_Clean, Ex_Str_Replace
...
def arrangeContent(textlist):
    temp_list = ["', '", '&nbsp;', ';\[笔趣看  www.biqukan.com\]', '\(https://www.biqukan.com/[0-9]{1,4}_[0-9]{3,8}/[0-9]{3,14}.html\)', 'www.biqukan.com。', 'wap.biqukan.com', 'www.biqukan.com', 'm.biqukan.com', 'n.biqukan.com', '百度搜索“笔趣看小说网”手机阅读:', '百度搜索“笔趣看小说网”手机阅读：', '请记住本书首发域名:', '请记住本书首发域名：', '笔趣阁手机版阅读网址:', '笔趣阁手机版阅读网址：', '<br />', ';\[笔趣看  \]']
    adict = {
        '<br />': '\n',
        '\r\r': '\n',
        '\r': '\n',
