...
Date         : 2025-06-16 13:06:20
LastEditTime : 2025-06-16 13:06:20
FilePath     : /CODE/test/unicodedata-test.py
...
if __name__ == "__main__":
    ...
    for i, test_text in enumerate(test_cases, 1):
        ...
        no_accents = cleaner.clean_and_normalize(test_text,
                                                 remove_accents=True)
        ascii_only = cleaner.clean_and_normalize(test_text,
                                                 remove_accents=True,
                                                 keep_only_ascii=True)
