...
#LastEditTime : 2020-06-01 22:08:40
...
from xjLib.Alispeek import ReqSynthesizer, get_token
    ...
    def main_monitor(self):
        def _func():
            while len(self.textlist) > 0:
                ...
                data = self._target(appkey, token, text, format=self.format, audioFile=None, *self._args, **self._kwargs)['data']
