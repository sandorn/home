...
LastEditTime : 2023-11-08 09:20:11
...
参数名	类型	必传	描述	示例
aue	string	是	音频编码，可选值：	"raw"
			raw：未压缩的pcm	"speex-org-wb;7" 数字代表指定压缩等级（默认等级为8），数字必传
...
sfl	int	否	需要配合aue=lame使用，开启流式返回	1
			mp3格式音频
			取值：1 开启
