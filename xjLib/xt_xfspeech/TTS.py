...
if __name__ == "__main__":
    str1 = """
    2023年，子公司管理部根据公司“正规化、体系化、制度化、专业化”的管理要求，调整原有的投后管理为主的模式，现阶段对子公司的管理会以财务管控型为主、局部操作型管控为辅。根据管理需求，选聘管理人员充实子公司经营管理层、建立并完善子公司管理制度、整理母子公司管理流程并稳妥推进优化、开展经营及离任审计并严肃处理有关违规违纪人员，积极跟进整改审计发现的问题；根据子公司不同业态和发展阶段差异，有侧重点的编制2024年经营计划目标，匹配相对应的组织绩效考核体系，为子公司发展步入正轨打下了坚实的基础。
    """
    Ws_Run(str1)
