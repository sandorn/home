...
@Date: 2019-05-04 23:29:28
@LastEditors: Even.Sand
@LastEditTime: 2019-05-04 23:29:28
'''
# ！/usr/bin/env python
# -*- coding:utf -8-*-
'''
@Software:   VSCode
@File    :   webkit嵌入式浏览器-1.py
@Time    :   2019/05/05 13:11:40
@Author  :   Even Sand
@Version :   1.0
@Contact :   sandorn@163.com
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.webview.titleChanged.connect(self.webTitle)  # 重点学习
    ...
    def create_tab(self, webview):
        self.tab = QWidget()
        self.tabWidget.addTab(self.tab, "新标签")
...
class WebEngineView(QWebEngineView):
    ...
    def on_downloadRequested(self, downloadItem):
        if not downloadItem.isFinished() and downloadItem.state() == 0:
            # 生成文件存储地址
    ...
    def on_downloadfinished(self):
        js_string = 'alert("下载成功，请到软件同目录下，查找下载文件！");'
