...
LastEditTime : 2025-09-09 13:07:42
...
from xt_thread.futures import FnInPool, ThreadPool
...
if __name__ == "__main__":
    ...
    ThreadPool_add_tasks(bookname, urls[0:10], get_contents)  # |perf_counter: 81.59s
