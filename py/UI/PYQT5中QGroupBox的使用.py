...
#Date         : 2020-05-13 15:28:59
#LastEditTime : 2020-05-13 15:33:15
#Github       : https://github.com/sandorn/home
#License      : (C)Copyright 2009-2020, NewSea
#==============================================================
https://blog.csdn.net/zhulove86/article/details/52431332
'''
...
class CheckBox(QWidget):
    ...
    def initUI(self):
        ...
        self.tristateBox.setTristate(True)  # 设定为三个状态
    ...
    def getCheckBoxStatus(self):
        ...
        )) + "\n" + self.checkBox2.text() + ":  " + str(
            self.checkBox2.checkState()) + "\n" + self.tristateBox.text(
            ) + ":  " + str(self.tristateBox.checkState())
        return status
