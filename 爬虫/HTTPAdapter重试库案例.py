...
#Date         : 2020-06-05 22:21:54
#FilePath     : /爬虫/HTTPAdapter重试库案例.py
#LastEditTime : 2020-06-05 22:35:07
#Github       : https://github.com/sandorn/home
#==============================================================
https://blog.csdn.net/dustyposa/article/details/100983107
https://github.com/Dustyposa/goSpider/tree/master/python_advance/requests请求重试
'''
import functools
import time
import types
...
if __name__ == '__main__':
    res = get_data("https://nls-gateway.cn-shanghai.aliyuncs.com/rest/v1/tts/async", time_out=1.)
    print(res)
